...
macro(dictosutil_setup_platform)
	...
	elseif ("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows")
		...
		set(DCORE_COMPILE_DEFINITIONS -D_WIN32_winn=0X0600 -DDCORE_PLAT_WIN -D_SCL_SECURE_NO_WARNINGS -DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE -D_SILENCE_ALL_CXX17_DEPRECATION_WARNINGS -DNOMAXMIN -D_CRT_SECURE_NO_WARNINGS)
		set(DCORE_PLAT_WIN 1)
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /std:c++17 /permissive- -D_SCL_SECURE_NO_WARNINGS -DBOOST_CONFIG_SUPPRESS_OUTDATED_MESSAGE -D_SILENCE_ALL_CXX17_DEPRECATION_WARNINGS -DNOMAXMIN -D_CRT_SECURE_NO_WARNINGS")
	...
	# Convert to list
	set(list ${DCORE_COMPILE_DEFINITIONS})
endmacro()
